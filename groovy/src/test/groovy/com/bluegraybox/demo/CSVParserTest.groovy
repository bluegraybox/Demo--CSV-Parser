...
public class CSVParserTest {
	...
	public void testSingleData() {
		...
		assertEquals(1.1, parser.getAverage("aaa"), 0.000001);
	}
	...
	public void testMultiData() {
		...
		assertEquals(1.4, parser.getAverage("aaa"), 0.000001);
	}
	...
	public void testMultiLineMultiData() {
		...
		assertEquals(2.9, parser.getAverage("aaa"), 0.000001);
	}
	...
	public void testNonNumeric() throws IOException {
		Reader reader = new StringReader("" +
			...
			"aaa,2011-03-28,1.3,2.3,3.3.4.3\n" +  // typo! period instead of comma; this whole line should be ignored.
			"aaa,2011-03-29,1.5,2.5,3.5,4.5\n" +
			"aaa,2011-03-30,1.7,2.7,3.7,4.7");
		parser.processReader(reader);
		assertEquals(2.9, parser.getAverage("aaa"), 0.000001);
